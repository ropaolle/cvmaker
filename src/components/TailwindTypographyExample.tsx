export default function TailwindTypographyExample() {
  return (
    <article className="prose lg:prose-xl">
      ...
      <p>
        ...
        <em>really are</em>
        just trying to style some content that came from a rich-text editor in a
      ...
      <p>
        It adds a new
        <code>prose</code>
        class that you can slap on any block of vanilla HTML content and turn it
        into a beautiful, well-formatted document:
      </p>
      <pre>
        <code className="lang-html">
          &lt;article className=<span className="hljs-string">"prose"</span>
          &gt; &lt;h1&gt;Garlic bread <span className="hljs-keyword">
            with
          </span>{" "}
          cheese: What <span className="hljs-keyword">the</span> science tells
          us&lt;/h1&gt; &lt;p&gt; For years parents have espoused{" "}
          <span className="hljs-keyword">the</span> health benefits{" "}
          <span className="hljs-keyword">of</span> eating garlic bread{" "}
          <span className="hljs-keyword">with</span> cheese{" "}
          <span className="hljs-built_in">to</span> their children,{" "}
          <span className="hljs-keyword">with</span>{" "}
          <span className="hljs-keyword">the</span> food earning such{" "}
          <span className="hljs-keyword">an</span> iconic status{" "}
          <span className="hljs-keyword">in</span> our culture that kids will
          often dress up <span className="hljs-keyword">as</span> warm, cheesy
          loaf <span className="hljs-keyword">for</span> Halloween. &lt;/p&gt;
          &lt;p&gt; But <span className="hljs-keyword">a</span> recent study
          shows that <span className="hljs-keyword">the</span> celebrated
          appetizer may be linked <span className="hljs-built_in">to</span>{" "}
          <span className="hljs-keyword">a</span> series{" "}
          <span className="hljs-keyword">of</span> rabies cases springing up
          around <span className="hljs-keyword">the</span> country. &lt;/p&gt;
          &lt;!
      ...
      {/* <pre><code className="lang-js">module.exports = {
<span className="hljs-symbol">  purge:</span> [],
<span className="hljs-symbol">  theme:</span> {
<span className="hljs-symbol">    extend:</span> {},
},
<span className="hljs-symbol">  variants:</span> {},
<span className="hljs-symbol">  plugins:</span> [],
}
</code></pre> */}
      ...
      <h4 id="we-haven-t-used-an-h4-yet">
        We haven't used an
        <code>h4</code>
        yet
      </h4>
      ...
      <h4 id="let-s-make-sure-we-don-t-screw-that-up-with-h4-elements-either-">
